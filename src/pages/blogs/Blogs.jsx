                ...
                <div class="grid gap-8 lg:grid-cols-2">
                    <article class="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">
                            ...
                            Asperiores doloribus eaque dolor incidunt ducimus,
                            veniam voluptates velit. Facere voluptatibus autem
                            officiis quidem dicta corrupti quasi? Suscipit
                    ...
                    <article class="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">
                            ...
                            molestiae! Animi, illum impedit veniam voluptas
                            reiciendis cumque doloribus eaque, laborum corporis
                            suscipit culpa facere, itaque dolorem voluptatibus.
                    ...
                    <article class="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">
                            ...
                            quod blanditiis soluta sapiente numquam aliquid
                            laboriosam rem vel quisquam laudantium quam dolorem!
                            Veniam, soluta. Aliquid quasi error incidunt hic
                    ...
                    <article class="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">
                            ...
                            tenetur molestias totam, eveniet saepe velit nemo
                            fugiat perspiciatis impedit doloribus natus. Tempore
                            hic error sunt voluptates atque deleniti
