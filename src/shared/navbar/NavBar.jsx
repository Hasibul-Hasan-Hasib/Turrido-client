        ...
        <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-main">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="335573297_855761355492125_7600712007123829334_n.jpg" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                    <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-main dark:border-gray-700">
                        <li>
