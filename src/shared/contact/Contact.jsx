...
const Contact = () => {
    return (
        <section className="body-font relative">
            <h1 className='text-3xl text-left my-8 text-center'>Contact Us</h1>
            <div className="container px-5 pb-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className=" lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input type="email" id="email" name="email" className="input input-bordered input-primary w-full" />
                    </div>
                    <div className="relative mb-4">
                        <label for="message" className="leading-7 text-sm text-gray-400">Message</label>
                        <textarea id="message" name="message" className="textarea textarea-primary w-full"></textarea>
                    </div>
                    <button className="btn btn-secondary border-0 py-2 px-6 focus:outline-none hover:bg-info rounded text-lg">Button</button>
